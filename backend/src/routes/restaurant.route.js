...
router.get('/all',checkPermission(moduleConstant.restaurant,actionConstant.read_all),getAllRestaurant)
router.get('/',checkPermission(moduleConstant.restaurant,actionConstant.read),getRestaurantInfoById)
